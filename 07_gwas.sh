...
bcftools query -l ../P_chalceus_NP25_BarSW_merged_filtered_mm80_thinned5k_multiSplit.vcf.gz | wc -l
...
plink --vcf ../P_chalceus_NP25_BarSW_merged_filtered_mm80_thinned5k_multiSplit.vcf.gz --pheno ../phenotype.txt --allow-no-sex --pheno-name WL \
