...
cd /scratch/leuven/361/vsc36175/NP25_gwas_action5trials_mm80
...
plink --vcf ../P_chalceus_NP25_BarSW_merged_filtered_mm80_multiSplit.vcf.gz --pheno ../phenotype.txt --allow-no-sex --pheno-name action5trials \
