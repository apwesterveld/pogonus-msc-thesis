...
bcftools query -l P_chalceus_NP25_BarSW_merged_filtered_mm80_multiSplit_bb.vcf.gz | wc -l
...
plink --vcf P_chalceus_NP25_BarSW_merged_filtered_mm80_multiSplit_bb.vcf.gz --pheno ../phenotype.txt --allow-no-sex --pheno-name relMRWS \
