...
cd /scratch/leuven/361/vsc36175/NP25_gwas_time_binary_bef100-aft200
...
#bcftools query -l P_chalceus_NP25_BarSW_merged_filtered_mm80_multiSplit_bef100-aft200.vcf.gz | wc -l
...
#plink --vcf P_chalceus_NP25_BarSW_merged_filtered_mm80_multiSplit_bef100-aft200.vcf.gz --pheno ../phenotype_time_binary.txt --allow-no-sex --pheno-name time_binary \
...
gemma -bfile gwas_input -k kinship_matrix/gwas_input.cXX.txt -bslmm 1 -outdir gemma_results -o gemma_lmm_results
