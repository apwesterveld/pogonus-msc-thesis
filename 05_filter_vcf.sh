...
bcftools view \
  -S ../karyotype_chr2_AA2.txt \
  -Oz -o P_chalceus_NP25_BarSW_merged_filtered_mm80_multiSplit_bb_AA.vcf.gz \
  P_chalceus_NP25_BarSW_merged_filtered_mm80_multiSplit_bb.vcf.gz
