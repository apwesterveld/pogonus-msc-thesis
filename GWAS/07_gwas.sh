...
plink --vcf ../P_chalceus_NP25_BarSW_merged_filtered_mm80_multiSplit.vcf.gz --pheno ../phenotype.txt --allow-no-sex --pheno-name relMRWS \
...
gemma -bfile gwas_input -k kinship_matrix/gwas_input.cXX.txt -c ../covariates.txt -lmm 4 -outdir gemma_results -o gemma_lmm_results
